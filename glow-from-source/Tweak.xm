...
- (void)viewDidLoad {
  ...
  [_containerView addSubview:_glowContentView]; _glowContentView.frame = _containerView.bounds;
  _glowContentView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
